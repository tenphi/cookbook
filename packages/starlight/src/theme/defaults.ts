...
export const DEFAULT_TYPOGRAPHY_PRESETS: Record<string, TypographyPreset> = {
  ...
  h1: heading("clamp(2.5rem, 5vw, 3.25rem)", 1.05, "-0.015em"),
  h2: heading("clamp(1.75rem, 3vw, 2.125rem)", 1.1, "-0.01em"),
  h3: heading("1.5rem", 1.15, "-0.006em"),
  h4: heading("1.25rem", 1.2, "-0.003em"),
  h5: heading("1.125rem", 1.25, "0"),
