...
export default function GlobalStyles() {
  ...
  useGlobalStyles(
    ".sl-markdown-content .td-mermaid:not(:where(.not-content *))",
    {
      display: "grid",
      placeItems: "center",
      minInlineSize: "0",
  ...
  useGlobalStyles(".sl-markdown-content .td-mermaid > svg", {
    $_text: "#text",
    "$_text-sec": "#text-soft",
  ...
  useGlobalStyles(".sl-markdown-content .td-mermaid text", {
    fontFamily: "$body-font-family",
  });

  useGlobalStyles(".sl-markdown-content .td-mermaid .mono", {
    fontFamily: "$code-font-family",
  });
