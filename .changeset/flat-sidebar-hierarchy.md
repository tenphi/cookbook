...
headers select their page while toggling children, preserve normal link and
keyboard behavior, and highlight only the current page instead of its ancestors.
